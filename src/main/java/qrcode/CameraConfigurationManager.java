...
final class CameraConfigurationManager {
	...
	CameraConfigurationManager(Context context, CaptureView captureView) {
	...
	void initFromCameraParameters(Camera camera) {
		...
		Log.d(TAG, "Default preview format: " + previewFormat + '/'
				+ previewFormatString);
		//screenResolution = new Point( captureView.getBottom(),captureView.getRight());
		screenResolution = new Point(captureView.getRight(), captureView.getBottom());
