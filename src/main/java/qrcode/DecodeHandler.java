...
final class DecodeHandler extends Handler {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            Message message = Message.obtain(this.captureView.getHandler(), MessageID.DECODE_SUCCCEDED, rawResult);
            ...
            Message message = Message.obtain(this.captureView.getHandler(), MessageID.DECODE_FAILED);
            message.sendToTarget();
        }
    }
