...
public class RefreshHorizontalScrollView extends RefreshBase<HorizontalScrollView> {
	...
	public RefreshHorizontalScrollView(Context context, Mode mode, AnimationStyle style) {
	...
	final class InternalHorizontalScrollViewSDK9 extends HorizontalScrollView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			OverscrollHelper.overScrollBy(RefreshHorizontalScrollView.this, deltaX, scrollX, deltaY, scrollY,
