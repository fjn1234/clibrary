...
public class OverscrollHelper {
     ...
     */
    public static void overScrollBy(final RefreshBase<?> view, final int deltaX, final int scrollX,
    ...
    public static void overScrollBy(final RefreshBase<?> view, final int deltaX, final int scrollX,
        ...
        if (view.isPullToRefreshOverScrollEnabled() && !view.isRefreshing()) {
            ...
            if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
                ...
                Log.d("OverscrollHelper", "OverScroll. DeltaX: " + deltaX + ", ScrollX: " + scrollX + ", DeltaY: " + deltaY
