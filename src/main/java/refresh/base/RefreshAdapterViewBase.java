...
import refresh.internal.IndicatorLayout;

/**
 * Created by meteorshower on 15/10/15.
 */
public abstract class RefreshAdapterViewBase<T extends AbsListView> extends RefreshBase<T> implements
        OnScrollListener {
    ...
    public RefreshAdapterViewBase(Context context, Mode mode1) {
        super(context, mode1);
        this.context = context;
        mRefreshableView.setOnScrollListener(this);
        init();
    ...
    public RefreshAdapterViewBase(Context context, Mode mode, AnimationStyle animStyle) {
    ...
    public final void setEmptyView(View newEmptyView) {
        ...
        if (mEmptyView != null && refreshableViewWrapper != null) {
     ...
     * setItemClickListener(listener)}. This is just for convenience!
     *
    ...
    private void addIndicatorViews() {
        ...
        if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
            ...
            params.rightMargin = getResources().getDimensionPixelSize(R.dimen.dp_10);
