...
import refresh.internal.RotateLoadingLayout;
import refresh.internal.ViewCompat;
import refresh.utils.ILoadingLayout;
import refresh.utils.IPullToRefresh;
...
public abstract class RefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    protected LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs,boolean isHeader) {
        LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,
                getPullToRefreshScrollDirection(), attrs,isHeader);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mHeaderLayout = createLoadingLayout(context, Mode.PULL_FROM_START, a,true);
        mFooterLayout = createLoadingLayout(context, Mode.PULL_FROM_END, a,false);
    ...
    public static enum AnimationStyle {
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs,boolean isHeader) {
            return new RotateLoadingLayout(context, mode, scrollDirection, attrs,isHeader);
        }
    }
    ...
    public static enum Mode {
         ...
         * {@link #setRefreshing() setRefreshing()}.
         */
    ...
    /** 提供拉动效果，但是无刷新模式 */
    public void setPullNoRefreshMode(){
        mHeaderLayout.setGoneRefreshMode();
        mFooterLayout.setGoneRefreshMode();
    }

//	/** 提供下拉效果，无刷新 --- 不稳定不建议使用 */
//	public void setPullNoRefreshStart(){
//		mHeaderLayout.setGoneRefreshMode();
//		mFooterLayout.setVisibRefreshMode();
//	}
//
//	/** 提供上拉效果，无刷新 --- 不稳定不建议使用 */
//	public void setPullNoRefreshEnd(){
//		mHeaderLayout.setVisibRefreshMode();
//		mFooterLayout.setGoneRefreshMode();
//	}
