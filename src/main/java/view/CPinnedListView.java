...
public class CPinnedListView extends CListView {
	    ...
	    public CPinnedListView(Context context, AttributeSet attrs) {
	        super(context, attrs);
	        initView();
	    }

	    public CPinnedListView(Context context, AttributeSet attrs, int defStyle) {
		...
		void createPinnedShadow(int position) {
			...
			View pinnedView = getAdapter().getView(position, pinnedShadow.view, CPinnedListView.this);
